...
# Commands[#](https://agent-browser.dev/commands#commands)
## Core[#](https://agent-browser.dev/commands#core)
...
## Get info[#](https://agent-browser.dev/commands#get-info)
...
## Check state[#](https://agent-browser.dev/commands#check-state)
...
## Find elements[#](https://agent-browser.dev/commands#find-elements)
...
## Wait[#](https://agent-browser.dev/commands#wait)
...
## Downloads[#](https://agent-browser.dev/commands#downloads)
...
## Mouse[#](https://agent-browser.dev/commands#mouse)
...
## Clipboard[#](https://agent-browser.dev/commands#clipboard)
...
## Settings[#](https://agent-browser.dev/commands#settings)
...
## Cookies & storage[#](https://agent-browser.dev/commands#cookies-storage)
...
## Network[#](https://agent-browser.dev/commands#network)
...
## Tabs & frames[#](https://agent-browser.dev/commands#tabs-frames)
...
### Stable tab ids and labels[#](https://agent-browser.dev/commands#stable-tab-ids-and-labels)
...
### Iframe support[#](https://agent-browser.dev/commands#iframe-support)
...
## Dialogs[#](https://agent-browser.dev/commands#dialogs)
...
## Streaming[#](https://agent-browser.dev/commands#streaming)
...
## Debug[#](https://agent-browser.dev/commands#debug)
...
## Auth vault[#](https://agent-browser.dev/commands#auth-vault)
...
## Confirmation[#](https://agent-browser.dev/commands#confirmation)
...
## State management[#](https://agent-browser.dev/commands#state-management)
...
## Sessions[#](https://agent-browser.dev/commands#sessions)
...
## Chrome profiles[#](https://agent-browser.dev/commands#chrome-profiles)
...
## Dashboard[#](https://agent-browser.dev/commands#dashboard)
...
## Doctor[#](https://agent-browser.dev/commands#doctor)
...
Exit code is `0` if all checks pass (warnings are fine), `1` if any fail. See the [Installation page](https://agent-browser.dev/installation#doctor) for the full check catalog.
## Chat[#](https://agent-browser.dev/commands#chat)
...
## Navigation[#](https://agent-browser.dev/commands#navigation)
...
## Pre-navigation setup[#](https://agent-browser.dev/commands#pre-navigation-setup)
Some flows need routes, cookies, or init scripts configured _before_ the first navigation (SSR debug, auth on protected origins, etc.). `open` without a URL launches the browser but stays on `about:blank`, leaving room to stage state. `batch` makes it one CLI invocation:
...
## React / Web Vitals[#](https://agent-browser.dev/commands#react-web-vitals)
...
## Init scripts[#](https://agent-browser.dev/commands#init-scripts)
...
## Global options[#](https://agent-browser.dev/commands#global-options)
...
## Batch execution[#](https://agent-browser.dev/commands#batch-execution)
...
## Command chaining[#](https://agent-browser.dev/commands#command-chaining)
...
## Local files[#](https://agent-browser.dev/commands#local-files)
